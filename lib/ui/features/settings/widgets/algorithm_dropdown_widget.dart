...
class AlgorithmDropdownWidget extends StatelessWidget {
  ...
  final ValueListenable<EncryptionType> encryptionAlgorithmListenable;

  @override
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      valueListenable: encryptionAlgorithmListenable,
      builder: (_, encryptionType, __) => DropdownButtonHideUnderline(
        child: Container(
